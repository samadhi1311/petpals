...
export default function Blog() {
    ...
    const dogTextContent = () => (
        <div className="content-card-2">
            ...
            <div className="dog-shelter-div">
                ...
                <div className="dog-shelter-text">
                    <h2>4. Register with a vet</h2><br/>
                    <p style={{ textAlign: 'left' }}>Registering with a vet is the first and most important step to protecting your dog from pain, injury, suffering and disease.</p><br/>
                    <p style={{ textAlign: 'left' }}>Further information providing details of how to care for your dog may be found here:</p><br/>
    ...
    const catTextContent = () => (
        <div className="content-card-2">
            ...
            <h3>5 things you must do</h3>
            <p>Adopting a cat is exciting, but it can often mean a big life change for you and<br/> them. To make things easier and give your new cat the best chance of settling in, it's really important to prepare for their arrival.</p><br/>
            <p>As well as having a moral duty to look after your new cat properly, you have a legal responsibility. Under the<br/> Animal Welfare Act, you must give your cat:</p>
            <ul style={{ textAlign: 'left' }}>
                <li>A suitable place to live</li>
                <li>A healthy diet and access to clean water</li>
                <li>The ability to behave normally</li>
            ...
            <p>So, to help you get ready for the big day and understand your legal responsibilities as a cat owner, we have<br/> created this to do list.</p>
            <div className="dog-shelter-div">
                <div className="dog-shelter-text">
                    <h2>1. Create safe spaces</h2><br/>
                    <p style={{ textAlign: 'left' }}>To feel safe and secure, cats need their own bed, hiding places and somewhere high up to view their surroundings.</p><br/>
                    <p style={{ textAlign: 'left' }}>Buy a comfortable and warm cat bed like an igloo or hammock, and put it somewhere quiet. You might want to buy more than one bed and have them in different rooms.</p><br/>
                    <p style={{ textAlign: 'left' }}>You can make beds and hiding places, too. Get an appropriate-sized cardboard box, turn it on its side and put a snuggly blanket inside. Again, place this in a quiet spot.</p><br/>
            ...
            <div className="dog-shelter-div">
                ...
                <div className="dog-shelter-text">
                    <h2>2. Set up a litter tray or outside toilet</h2><br/>
                    <p style={{ textAlign: 'left' }}>Cats like to go to the toilet where they feel safe, and in a place that allows them to bury their waste afterwards.</p><br/>
                    <p style={{ textAlign: 'left' }}>If your cat already uses a litter tray or you do not have a garden, you will need to set up a litter tray before they arrive.</p><br/>
                    <p style={{ textAlign: 'left' }}>If your cat prefers to toilet outside and you have got a garden, or you want to train them to toilet outside, pick an area that is close to the house yet private. Once they arrive, you can encourage them to toilet there.</p><br/>
                </div>
            </div>
            <div className="dog-shelter-div">
                <div className="dog-shelter-text">
                    <h2>3. Stock up on the right food</h2><br/>
                    <p style={{ textAlign: 'left' }}>Cats must have healthy, balanced diets and access to fresh water at all times. At first, it is best to continue with the food the cat has been used to. Ask the person you are adopting from what the cat eats, then buy plenty of it.</p><br/>
                    ...
                    <p style={{ textAlign: 'left' }}>Lots of cats like to eat a special type of grass called Cocksfoot because it helps them clear furballs. Have some in the house to stop them chewing other houseplants!</p><br/>
                </div>
                <div className="dog-shelter-img">
                    <div className='content-image'>
            ...
            <div className="dog-shelter-div">
                ...
                <div className="dog-shelter-text">
                    <h2>4. Get a scratch post</h2><br/>
                    <p style={{ textAlign: 'left' }}>Scratching is a big part of being a cat. Encourage them to carry out this natural behaviour by investing in a proper scratch post. This will discourage them from stretching and scratching on your furniture, too.</p><br/>
                    <p style={{ textAlign: 'left' }}>Put the post near their bed so they can stretch and scratch when they wake up something that most cats tend to do.</p><br/>
                </div>
            </div>
            <div className="dog-shelter-div">
                <div className="dog-shelter-text">
                    <h2>5. Plan for holidays</h2><br/>
                    <p style={{ textAlign: 'left' }}>Even though cats are relatively independent pets, they cannot be left alone for long periods of time. When you go away, you will need to find a cat-sitter or put them in a cattery. Research your options early so you do not end up in a difficult situation.</p>
                </div>
                <div className="dog-shelter-img">
                    <div className='content-image'>
            ...
            <div className="dog-shelter-div">
                ...
                <div className="dog-shelter-text">
                    <h2>6. Register with a vet</h2><br/>
                    <p style={{ textAlign: 'left' }}>As Cat Welfare Code of Practise explains, you should get as much information as possible about your cats health from their previous owner. Ask for: details of their old vet, vaccination records, information about any health conditions and medications, and whether or not they have been microchipped.</p><br/>
                    <p style={{ textAlign: 'left' }}>More information about cat welfare may be found in the</p><br/>
                    <p style={{ textAlign: 'left' }}>
