	...
	async function compressImage(file) {
		return new Promise((resolve) => {
			...
			if (!(file instanceof File || file instanceof Blob)) {
				resolve(file);
				return <Modal success={false} title='Error' content='Invalid file type for compression' />;
			}
									...
									{({ values, errors }) => (
										<motion.div
											...
											<Form className='add-form'>
												...
												<button className='add-page-submit' type='submit' disabled={errors.age || errors.petDescription || errors.img1 || errors.img2 || errors.img3}>
