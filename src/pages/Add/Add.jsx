    ...
    return (
        ...
        <main className='add-page'>
            <AnimatePresence mode="wait">
                {
                    success ? <Modal title="Good Job!!" content="Your pet pal has been added successfully!" success={true} /> :
                        (
                                            ...
                                            <Form className="add-form">
                                                ...
                                                <div className="add-image-selector">
                                                    ...
                                                    <div className="add-select-images">
                                                        ...
                                                        <div className="add-image-containers">
                                                            <label htmlFor='img1' style={{ backgroundImage: petImages.img1 ? `url(${petImages.img1})` : 'none', backgroundColor: petImages.img1 ? 'transparent' : 'white', borderRadius: '12px', backgroundSize: 'cover', boxShadow: petImages.img1 ? 'inset 0 0 0 100vmax rgba(0, 0, 0, 0.5)' : 'none' }}>
                                                                <div className="add-image-container">
                                                                    {<i className='bx bx-image-add bx-md upload-icon' style={{ color: petImages.img1 ? 'white' : 'black', }}></i>}
                                                                </div>
                                                            </label>

                                                            <label htmlFor='img2' style={{ backgroundImage: petImages.img2 ? `url(${petImages.img2})` : 'none', backgroundColor: petImages.img2 ? 'transparent' : 'white', borderRadius: '12px', backgroundSize: 'cover', boxShadow: petImages.img2 ? 'inset 0 0 0 100vmax rgba(0, 0, 0, 0.5)' : 'none' }}>
                                                                <div className="add-image-container">
                                                                    {<i className='bx bx-image-add bx-md upload-icon' style={{ color: petImages.img2 ? 'white' : 'black' }}></i>}
                                                                </div>
                                                            </label>

                                                            <label htmlFor='img3' style={{ backgroundImage: petImages.img3 ? `url(${petImages.img3})` : 'none', backgroundColor: petImages.img3 ? 'transparent' : 'white', borderRadius: '12px', backgroundSize: 'cover', boxShadow: petImages.img3 ? 'inset 0 0 0 100vmax rgba(0, 0, 0, 0.5)' : 'none' }}>
                                                                <div className="add-image-container">
                                                        ...
                                                        <input type="file" name='img1' id='img1' accept="image/*" className='add-image-upload' onChange={(e) => handleImageChange(e, 'img1', values)} />
                                                        <input type="file" name='img2' id='img2' accept="image/*" className='add-image-upload' onChange={(e) => handleImageChange(e, 'img2', values)} />
                                                        <input type="file" name='img3' id='img3' accept="image/*" className='add-image-upload' onChange={(e) => handleImageChange(e, 'img3', values)} />
                                                    </div>
                                                ...
                                                <div className="add-description-section">
                                                    ...
                                                    <div className="add-write-description">
                                                        <label htmlFor="pet-description" className="add-description">A brief description about your pet:</label>
                                                ...
                                                <button className='add-page-submit' type='submit'>Submit</button>
                                            </Form>
                                        </motion.div>
                                    )
                                }
